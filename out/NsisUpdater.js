...
const win_verify_signature_1 = require("win-verify-signature");
class NsisUpdater extends BaseUpdater_1.BaseUpdater {
    ...
    async verifySignature(tempUpdateFile) {
        ...
        const result = (0, win_verify_signature_1.verifySignatureByPublishName)(tempUpdateFile, Array.isArray(publisherName) ? publisherName : [publisherName]);
        (_a = this.logger) === null || _a === void 0 ? void 0 : _a.info(result.message);
        if (result.signed) {
            return null;
        }
